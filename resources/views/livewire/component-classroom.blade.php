<div class="m-4">
    ...
    <x-template-list>
                ...
                @slot('body')
                    @foreach ($classrooms as $classroom)
                        <tr
                            ...
                            <td class="px-6 py-4">
                                {{ $classroom->sublevel->level->name }}
                            </td>

                            <td class="px-6 py-4">
                                {{ $classroom->sublevel->name }}
                            </td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-left">
                                <ul>
                                    <li>
                                        <a wire:click='edit({{ $classroom->id }})'
                                    ...
                                    <li>
                                        <a wire:click='modalDelete({{ $classroom->id }})'
        ...
        @slot('paginate')
            {{ $classrooms->links('vendor.livewire.custom') }}
        @endslot
    </x-template-list>
