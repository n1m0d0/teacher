<div class="m-4">
    <x-template-form>
        ...
        @slot('form')
            ...
            <div class="col-span-1 md:col-span-6">
                ...
                <x-input type="text" wire:model='core' />

                <x-input-error for="core" />
            </div>
        @endslot
    ...
    <x-template-list>
                        ...
                        <tr
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-left">
                                <ul>
                                    ...
                                    <li>
                                        <a wire:click='modalDelete({{ $school->id }})'
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-left">
                                <ul>
                                    <li>
                                        <a href="{{ route('page.classroom', $school) }}"
                                            class="font-medium text-blue-600 dark:text-blue-500 hover:underline cursor-pointer">
                                            {{ __('Classroom') }}
                                        </a>
                                    </li>
                                    ...
                                    <li>
                                        <a href="{{ route('page.student', $school) }}"
                                    ...
                                    <li>
                                        <a href="{{ route('page.attendance', $school) }}"
        ...
        @slot('paginate')
            {{ $schools->links('vendor.livewire.custom') }}
        @endslot
    </x-template-list>
